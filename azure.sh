...
echo "📌 Criando infraestrutura (App Nativa + Docker para Relatórios)..."
...
# Azure Container Registry (apenas para a imagem de relatórios)
az acr create --resource-group "$AZ_RG" --name "$AZ_ACR_NAME" --sku Basic --admin-enabled true

# Web App (Runtime Nativo Node 24)
